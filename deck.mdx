...
# I am [Zain Fathoni](https://zainfathoni.com) 🤝
...
# 🎁 Bonus: Serving in Two Different Domains

<ul>
  <Appear>
    <li>🇮🇩 <a href="https://www.ninjaxpress.co">www.ninjaxpress.co</a> is only for Indonesia</li>
    <li>🇸🇬 <a href="https://www.ninjavan.co">www.ninjavan.co</a> is for the rest 🇲🇾🇵🇭🇹🇭🇻🇳</li>
    <li>💻 Point both domains into <strong>the same server</strong></li>
    <li>🔁 <strong>JS redirect</strong> for path & domain <a href="https://www.ninjavan.co/en-id">mismatch</a></li>
    <li>🏷 Setup <a href="https://ahrefs.com/blog/hreflang-tags/"><code>hreflang</code> tag</a> correctly for SEO</li>
  </Appear>
</ul>
